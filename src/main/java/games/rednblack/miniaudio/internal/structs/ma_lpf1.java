...
public final class ma_lpf1 extends Struct {
    ...
    static {
        __ffi_type = FFITypes.getCTypeInfo(159).getFfiType();
        __size = CHandler.getSizeFromFFIType(__ffi_type);
    }

    public ma_lpf1(long pointer, boolean freeOnGC) {
        super(pointer, freeOnGC);
    }

    public ma_lpf1(long pointer, boolean freeOnGC, Pointing parent) {
        super(pointer, freeOnGC);
        setParent(parent);
    }
    ...
    public ma_lpf1.ma_lpf1Pointer asPointer() {
        return new ma_lpf1.ma_lpf1Pointer(getPointer(), false, 1, this);
    }

    public void asPointer(ma_lpf1.ma_lpf1Pointer ptr) {
        ptr.setPointer(this);
    }
    ...
    public static final class ma_lpf1Pointer extends StackElementPointer<ma_lpf1> {

        public ma_lpf1Pointer(VoidPointer pointer) {
            super(pointer);
        }

        public ma_lpf1Pointer(long pointer, boolean freeOnGC) {
            super(pointer, freeOnGC);
        }

        public ma_lpf1Pointer(long pointer, boolean freeOnGC, int capacity) {
            super(pointer, freeOnGC, capacity * __size);
        }

        public ma_lpf1Pointer(long pointer, boolean freeOnGC, Pointing parent) {
            super(pointer, freeOnGC);
            setParent(parent);
        }

        public ma_lpf1Pointer(long pointer, boolean freeOnGC, int capacity, Pointing parent) {
            super(pointer, freeOnGC, capacity * __size);
            setParent(parent);
        }

        public ma_lpf1Pointer() {
            this(1, true);
        }

        public ma_lpf1Pointer(int count, boolean freeOnGC) {
        ...
        protected ma_lpf1 createStackElement(long ptr, boolean freeOnGC) {
            return new ma_lpf1(ptr, freeOnGC);
        }
    }
}
